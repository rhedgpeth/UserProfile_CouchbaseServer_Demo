...
namespace UserProfileDemo.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        // GET: api/users?firstName=Rob&enabled=true&countryCode=BO&limit=5&offset=0
        [HttpGet]
        [Route("filter")]
        ...
        // PUT api/users/user::05b6cc06-b48c-4b3d-be09-d2d442a3c975
        //[HttpPut("{id}")]
        //public void Put(string id, [FromBody]User value) => throw new NotImplementedException();
